...
const Contact = () => {
  return (
    <Layout>
      <HeroSection title="Contact Us" image={image} />
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
              <div>
                <p className="text-gray-900 text-lg font-normal leading-7 lg:text-left text-center">
                  Get in Touch with Adna Earth Thank you for considering Adna
                  Earth for your baby care needs. We value your feedback,
                  inquiries, and suggestions, and we're here to assist you in
                  any way we can. Please feel free to reach out to us
                </p>
                <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-green-600">
                    <a
                      href="javascript:;"
                      className="w-14 h-14 bg-green-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                    >
                      <svg
                ...
                <div className="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                  ...
                  >
                    163 Reviews on{" "}
                    <span className="text-emerald-500"> Amazon </span>
                  </a>
                </div>
              </div>
              <form
              ...
              >
                ...
                <button className="w-full h-12 rounded-full bg-green-600 hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
                  Send message{" "}
                  <svg
                    width="20"
                    height="20"
